...
public class ManageAddProdServlet extends HttpServlet {
    ...
    @SuppressWarnings({"RedundantThrows", "AccessStaticViaInstance", "unchecked", "StringConcatenationInLoop", "TryFinallyCanBeTryWithResources", "ResultOfMethodCallIgnored"})
